...
function dvwaHtmlEcho( $pPage ) {
	...
	foreach( $menuBlocks as $menuBlock ) {
		...
		foreach( $menuBlock as $menuItem ) {
			...
			$menuHtml .= "<a class=\"dropdown-item\" href=\"{$fixedUrl}\" style='padding-bottom:0px;padding-top:0px;'>{$menuItem[ 'name' ]}</a>\n";
		}
	...
	$systemInfoHtml = "";
	if( dvwaIsLoggedIn() ) 
		$systemInfoHtml = "<div align=\"left\" style='padding-left:20px;'>{$userInfoHtml}<br />{$securityLevelHtml}<br />{$localeHtml}<br />{$phpIdsHtml}</div>";
...
<html lang=\"en-GB\">
	...
	<nav class=\"navbar navbar-expand-lg navbar-dark bg-dark\" style='position:fixed;top:0;width:100%;'>
		...
		<img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/logo.png\" alt=\"Damn Vulnerable Web Application\" style='width:100px;margin-right:2%;'/>
          ...
          <div class=\"collapse navbar-collapse\" id=\"navbarColor02\">
            <ul class=\"navbar-nav me-auto\">
              <li class=\"nav-item\">
                <a class=\"nav-link active\" href=\"/dvwa/\">Home
                  <span class=\"visually-hidden\">(current)</span>
                </a>
              </li>
			  <li class=\"nav-item dropdown\" style='z-index:2;'>
                <div class=\"nav-link dropdown-toggle\" data-bs-toggle=\"dropdown\" href=\"#\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Status</div>
                <div class=\"dropdown-menu\" >
				{$systemInfoHtml}
                </div>
              </li>
              <li class=\"nav-item dropdown\" style='z-index:2;'>
                <div class=\"nav-link dropdown-toggle\" data-bs-toggle=\"dropdown\" href=\"#\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Options</div>
                <div class=\"dropdown-menu\">
				{$menuHtml}
                </div>
              </li> 
		...
		<div id=\"container\">
			...
			<div id=\"footer\">
				...
				<p style='text-align:center;'>Damn Vulnerable Web Application (DVWA) v" . dvwaVersionGet() . "</p>
