...
<div class="body_padded">
	...
	<form name="low_js" method="post">
		...
		<label for="phrase">Phrase</label> <input type="text" name="phrase" value="ChangeMe" id="phrase" class='form-control' style='width:30%;'/></br>
		<input type="submit" id="send" name="send" value="Submit" class='btn btn-success' /></br></br></br>
	</form>
EOF;
}
